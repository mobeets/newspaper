...
\end{center}
\center\includegraphics[width=1.1\linewidth]{images/comic-pearls.png}
\center\includegraphics[width=1.1\linewidth]{images/comic-calvinandhobbes.png}
